...
// تابع تبدیل اعداد به فارسی برای نمایش در جدول‌ها
...
// تابع تبدیل اعداد به فارسی برای نمایش در کارت‌های آماری
export const formatStatCardNumber = (number) => {
  if (number === null || number === undefined) return '۰';
  ...
  if (typeof number === 'number') {
    ...
    if (number >= 1000000) {
      const millions = (number / 1000000).toFixed(1);
      return toPersianNumbers(millions) + ' میلیون';
    }
